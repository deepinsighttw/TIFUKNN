...
def generate_dictionary_BA(files, attributes_list):
    ...
    # 目的應該為重新幫 MATERIAL_NUMBER 等 attr 重新編號，從 0 開始
    dictionary_table = {}
    counter_table = {}
    ...
    for filename in files:
        ...
        with open(filename, 'r') as csvfile:
            ...
            for row in reader:
                ...
                # row: CUSTOMER_ID,ORDER_NUMBER,MATERIAL_NUMBER
    ...
    for file_id in range(len(files)):
        ...
        with open(filename, 'r') as csvfile:
            ...
            for row in reader:
                ...
                # customer_id: [[-1], [1st item vector], [2nd item vector], ..., [-1]]
                # 所以 customer_id 的資料要放一起，並且要根據訂單次序排列
